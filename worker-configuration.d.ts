/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a46067fedb19a639d28c7ffc7f9dcff)
...
declare namespace Cloudflare {
	...
	interface Env {
		IMG_SIGNING_SECRET: string;
		INTERNAL_RAW_TOKEN: string;
		ALLOWED_REFERER_PREFIXES: string;
		R2_BUCKET: R2Bucket;
	}
}
